...
export default function AIAssistant() {
    ...
    const send = async (text) => {
        ...
        logSearch(userText).catch(() => { });

        try {
            // Build message history for the API (only user/bot messages in text form)
            const history = newMessages.map(m => ({ role: m.role === 'user' ? 'user' : 'bot', text: m.text }));
    ...
    const formatText = (text) => {
        // Render line breaks and bold text (**word**) in bot messages
        return text.split('\n').map((line, i) => {
            ...
            <div className="ai-wrap">
                <div className="ai-header-card card card-p">
                    ...
                    <div className="ai-header-text">
                        ...
                        <p>AI-powered campus guide · Powered by Gemini</p>
                    </div>
