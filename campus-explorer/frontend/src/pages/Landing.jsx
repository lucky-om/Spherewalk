                    ...
                    <div className="bento-grid">
                        {features.map((f, i) => (
                            <Link
                                ...
                                style={{ '--feat-clr': f.color, animationDelay: `${i * 100}ms` }}
                            >
            ...
            <footer className="landing-footer">
                <div className="footer-inner container">
                    ...
                    <div className="footer-brand-col">
                        ...
                        <p className="footer-tagline">Navigate campus smarter with AR, AI & 360° tours.</p>
                    ...
                    {/* Contributors */}
                    <div className="footer-col">
                        <h5 className="footer-col-title">Contributors</h5>
                        <ul>
                            <li><span>Jeet Patel</span></li>
                            <li><span>Akshit Patel</span></li>
                            <li><span>Daksh Patel</span></li>
                            <li><span>Devansh Jariwala</span></li>
                            <li><span>Om Patel</span></li>
                        </ul>
                    </div>
                ...
                <div className="footer-bottom">
                    <div className="container">
                        <span>Made with care by Green Node · SphereWalk v1.0</span>
                    </div>
                </div>
            </footer>
        </div>
