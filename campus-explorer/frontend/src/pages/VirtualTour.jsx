...
export default function VirtualTour() {
    ...
    useEffect(() => {
        const init = () => {
            ...
            // Clone TOUR_SCENES and attach createTooltipFunc + clickHandlerFunc to each hotspot
            const scenesWithCards = {};
            Object.entries(TOUR_SCENES).forEach(([id, scene]) => {
                scenesWithCards[id] = {
                    ...scene,
    ...
    }, []); // Only init once with scenes configured
    ...
    const currentTour = TOUR_LIST.find(t => t.id === selectedId) || TOUR_LIST[0];
        ...
        <div className="tour-page page">
            <div className="tour-layout">
                <aside className="tour-sidebar">
                    ...
                    {levels.map(lv => {
                        const items = TOUR_LIST.filter(t => t.level === lv);
                ...
                <main className="tour-main">
                    ...
                    <div className="panorama-wrapper">
                        ...
                        <div className="panorama-hotspot-overlay">
                            {TOUR_SCENES[selectedId]?.hotSpots?.map((h, i) => (
                                <button
                                    key={`${selectedId}-${i}`}
